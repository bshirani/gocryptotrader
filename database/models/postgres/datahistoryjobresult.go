...
var DatahistoryjobresultTableColumns = struct {
	ID                string
	JobID             string
	Result            string
	Status            string
	...
	ID:                "datahistoryjobresult.id",
	JobID:             "datahistoryjobresult.job_id",
	Result:            "datahistoryjobresult.result",
	Status:            "datahistoryjobresult.status",
	IntervalStartTime: "datahistoryjobresult.interval_start_time",
	IntervalEndTime:   "datahistoryjobresult.interval_end_time",
	RunTime:           "datahistoryjobresult.run_time",
}
...
type datahistoryjobresultR struct {
	Job *Datahistoryjob `boil:"Job" json:"Job" toml:"Job" yaml:"Job"`
}
...
type (
	...
	// This should almost always be used instead of []Datahistoryjobresult.
...
func FindDatahistoryjobresult(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*Datahistoryjobresult, error) {
	...
	if err = datahistoryjobresultObj.doAfterSelectHooks(ctx, exec); err != nil {
		return datahistoryjobresultObj, err
	}
