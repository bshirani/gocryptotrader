...
var WithdrawalFiatTableColumns = struct {
	ID                string
	WithdrawalFiatID  string
	BankName          string
	BankAddress       string
	...
	ID:                "withdrawal_fiat.id",
	WithdrawalFiatID:  "withdrawal_fiat.withdrawal_fiat_id",
	BankName:          "withdrawal_fiat.bank_name",
	BankAddress:       "withdrawal_fiat.bank_address",
	BankAccountName:   "withdrawal_fiat.bank_account_name",
	BankAccountNumber: "withdrawal_fiat.bank_account_number",
	BSB:               "withdrawal_fiat.bsb",
	SwiftCode:         "withdrawal_fiat.swift_code",
	Iban:              "withdrawal_fiat.iban",
	BankCode:          "withdrawal_fiat.bank_code",
}
...
type withdrawalFiatR struct {
	WithdrawalFiat *WithdrawalHistory `boil:"WithdrawalFiat" json:"WithdrawalFiat" toml:"WithdrawalFiat" yaml:"WithdrawalFiat"`
}
...
type (
	...
	// This should almost always be used instead of []WithdrawalFiat.
...
func (withdrawalFiatL) LoadWithdrawalFiat(ctx context.Context, e boil.ContextExecutor, singular bool, maybeWithdrawalFiat interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`withdrawal_history.id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func FindWithdrawalFiat(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*WithdrawalFiat, error) {
	...
	if err = withdrawalFiatObj.doAfterSelectHooks(ctx, exec); err != nil {
		return withdrawalFiatObj, err
	}
