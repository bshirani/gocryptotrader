...
type LiveOrder struct {
	...
	InternalType    string    `boil:"internal_type" json:"internal_type" toml:"internal_type" yaml:"internal_type"`
...
var LiveOrderTableColumns = struct {
	...
	InternalType:    "live_order.internal_type",
...
var LiveOrderWhere = struct {
	...
	InternalType    whereHelperstring
	...
	InternalType:    whereHelperstring{field: "\"live_order\".\"internal_type\""},
...
var (
	liveOrderAllColumns            = []string{"id", "status", "order_type", "internal_type", "exchange", "strategy_name", "internal_id", "side", "client_order_id", "amount", "symbol", "price", "stop_loss_price", "take_profit_price", "fee", "cost", "filled_at", "asset_type", "active_at", "cancelled_at", "created_at", "updated_at"}
	liveOrderColumnsWithoutDefault = []string{"status", "order_type", "internal_type", "exchange", "strategy_name", "internal_id", "side", "amount", "symbol", "price", "filled_at", "active_at", "cancelled_at"}
