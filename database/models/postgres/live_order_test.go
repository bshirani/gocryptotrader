...
func testLiveOrdersUpsert(t *testing.T) {
	t.Parallel()
	...
	if err = o.Upsert(ctx, tx, false, nil, boil.Infer(), boil.Infer()); err != nil {
		t.Errorf("Unable to upsert LiveOrder: %s", err)
	}
	...
	if err = randomize.Struct(seed, &o, liveOrderDBTypes, false, liveOrderPrimaryKeyColumns...); err != nil {
		t.Errorf("Unable to randomize LiveOrder struct: %s", err)
	}
