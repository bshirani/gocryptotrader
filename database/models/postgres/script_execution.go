...
var ScriptExecutionTableColumns = struct {
	ID              string
	ScriptID        string
	ExecutionType   string
	ExecutionStatus string
	...
	ScriptID:        "script_execution.script_id",
	ExecutionType:   "script_execution.execution_type",
	ExecutionStatus: "script_execution.execution_status",
	ExecutionTime:   "script_execution.execution_time",
}
...
type scriptExecutionR struct {
	Script *Script `boil:"Script" json:"Script" toml:"Script" yaml:"Script"`
}
...
type (
	...
	// This should almost always be used instead of []ScriptExecution.
...
func FindScriptExecution(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*ScriptExecution, error) {
	...
	if err = scriptExecutionObj.doAfterSelectHooks(ctx, exec); err != nil {
		return scriptExecutionObj, err
	}
