...
var WithdrawalHistoryTableColumns = struct {
	ID             string
	ExchangeID     string
	Status         string
	Currency       string
	...
	ExchangeID:     "withdrawal_history.exchange_id",
	Status:         "withdrawal_history.status",
	Currency:       "withdrawal_history.currency",
	Amount:         "withdrawal_history.amount",
	Description:    "withdrawal_history.description",
	WithdrawType:   "withdrawal_history.withdraw_type",
	CreatedAt:      "withdrawal_history.created_at",
	UpdatedAt:      "withdrawal_history.updated_at",
	ExchangeNameID: "withdrawal_history.exchange_name_id",
}
...
type withdrawalHistoryR struct {
	...
	WithdrawalCryptoWithdrawalCryptos WithdrawalCryptoSlice `boil:"WithdrawalCryptoWithdrawalCryptos" json:"WithdrawalCryptoWithdrawalCryptos" toml:"WithdrawalCryptoWithdrawalCryptos" yaml:"WithdrawalCryptoWithdrawalCryptos"`
	WithdrawalFiatWithdrawalFiats     WithdrawalFiatSlice   `boil:"WithdrawalFiatWithdrawalFiats" json:"WithdrawalFiatWithdrawalFiats" toml:"WithdrawalFiatWithdrawalFiats" yaml:"WithdrawalFiatWithdrawalFiats"`
}
...
type (
	...
	// This should almost always be used instead of []WithdrawalHistory.
...
func (withdrawalHistoryL) LoadWithdrawalCryptoWithdrawalCryptos(ctx context.Context, e boil.ContextExecutor, singular bool, maybeWithdrawalHistory interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`withdrawal_crypto`),
		qm.WhereIn(`withdrawal_crypto.withdrawal_crypto_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (withdrawalHistoryL) LoadWithdrawalFiatWithdrawalFiats(ctx context.Context, e boil.ContextExecutor, singular bool, maybeWithdrawalHistory interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`withdrawal_fiat`),
		qm.WhereIn(`withdrawal_fiat.withdrawal_fiat_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func FindWithdrawalHistory(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*WithdrawalHistory, error) {
	...
	if err = withdrawalHistoryObj.doAfterSelectHooks(ctx, exec); err != nil {
		return withdrawalHistoryObj, err
	}
