...
var (
	currencyAllColumns            = []string{"id", "symbol", "cmc_id", "name", "slug", "first_historical_data", "last_historical_data", "market_cap", "active", "status", "created_at", "updated_at"}
	currencyColumnsWithoutDefault = []string{"symbol", "cmc_id", "name", "slug", "first_historical_data", "last_historical_data", "market_cap", "active", "status"}
