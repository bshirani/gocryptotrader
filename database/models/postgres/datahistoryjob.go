...
var DatahistoryjobTableColumns = struct {
	ID                       string
	Nickname                 string
	ExchangeNameID           string
	Asset                    string
	...
	ID:                       "datahistoryjob.id",
	Nickname:                 "datahistoryjob.nickname",
	ExchangeNameID:           "datahistoryjob.exchange_name_id",
	Asset:                    "datahistoryjob.asset",
	Base:                     "datahistoryjob.base",
	Quote:                    "datahistoryjob.quote",
	StartTime:                "datahistoryjob.start_time",
	EndTime:                  "datahistoryjob.end_time",
	DataType:                 "datahistoryjob.data_type",
	Interval:                 "datahistoryjob.interval",
	RequestSize:              "datahistoryjob.request_size",
	MaxRetries:               "datahistoryjob.max_retries",
	BatchCount:               "datahistoryjob.batch_count",
	Status:                   "datahistoryjob.status",
	Created:                  "datahistoryjob.created",
	ConversionInterval:       "datahistoryjob.conversion_interval",
	OverwriteData:            "datahistoryjob.overwrite_data",
	DecimalPlaceComparison:   "datahistoryjob.decimal_place_comparison",
	SecondaryExchangeID:      "datahistoryjob.secondary_exchange_id",
	IssueTolerancePercentage: "datahistoryjob.issue_tolerance_percentage",
	ReplaceOnIssue:           "datahistoryjob.replace_on_issue",
}
...
type datahistoryjobR struct {
	...
	SecondaryExchange              *Exchange                 `boil:"SecondaryExchange" json:"SecondaryExchange" toml:"SecondaryExchange" yaml:"SecondaryExchange"`
	SourceJobCandles               CandleSlice               `boil:"SourceJobCandles" json:"SourceJobCandles" toml:"SourceJobCandles" yaml:"SourceJobCandles"`
	ValidationJobCandles           CandleSlice               `boil:"ValidationJobCandles" json:"ValidationJobCandles" toml:"ValidationJobCandles" yaml:"ValidationJobCandles"`
	PrerequisiteJobDatahistoryjobs DatahistoryjobSlice       `boil:"PrerequisiteJobDatahistoryjobs" json:"PrerequisiteJobDatahistoryjobs" toml:"PrerequisiteJobDatahistoryjobs" yaml:"PrerequisiteJobDatahistoryjobs"`
	JobDatahistoryjobs             DatahistoryjobSlice       `boil:"JobDatahistoryjobs" json:"JobDatahistoryjobs" toml:"JobDatahistoryjobs" yaml:"JobDatahistoryjobs"`
	JobDatahistoryjobresults       DatahistoryjobresultSlice `boil:"JobDatahistoryjobresults" json:"JobDatahistoryjobresults" toml:"JobDatahistoryjobresults" yaml:"JobDatahistoryjobresults"`
}
...
type (
	...
	// This should almost always be used instead of []Datahistoryjob.
...
func (datahistoryjobL) LoadSourceJobCandles(ctx context.Context, e boil.ContextExecutor, singular bool, maybeDatahistoryjob interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`candle`),
		qm.WhereIn(`candle.source_job_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (datahistoryjobL) LoadValidationJobCandles(ctx context.Context, e boil.ContextExecutor, singular bool, maybeDatahistoryjob interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`candle`),
		qm.WhereIn(`candle.validation_job_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (datahistoryjobL) LoadPrerequisiteJobDatahistoryjobs(ctx context.Context, e boil.ContextExecutor, singular bool, maybeDatahistoryjob interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.Select("\"datahistoryjob\".id, \"datahistoryjob\".nickname, \"datahistoryjob\".exchange_name_id, \"datahistoryjob\".asset, \"datahistoryjob\".base, \"datahistoryjob\".quote, \"datahistoryjob\".start_time, \"datahistoryjob\".end_time, \"datahistoryjob\".data_type, \"datahistoryjob\".interval, \"datahistoryjob\".request_size, \"datahistoryjob\".max_retries, \"datahistoryjob\".batch_count, \"datahistoryjob\".status, \"datahistoryjob\".created, \"datahistoryjob\".conversion_interval, \"datahistoryjob\".overwrite_data, \"datahistoryjob\".decimal_place_comparison, \"datahistoryjob\".secondary_exchange_id, \"datahistoryjob\".issue_tolerance_percentage, \"datahistoryjob\".replace_on_issue, \"a\".\"job_id\""),
...
func (datahistoryjobL) LoadJobDatahistoryjobs(ctx context.Context, e boil.ContextExecutor, singular bool, maybeDatahistoryjob interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.Select("\"datahistoryjob\".id, \"datahistoryjob\".nickname, \"datahistoryjob\".exchange_name_id, \"datahistoryjob\".asset, \"datahistoryjob\".base, \"datahistoryjob\".quote, \"datahistoryjob\".start_time, \"datahistoryjob\".end_time, \"datahistoryjob\".data_type, \"datahistoryjob\".interval, \"datahistoryjob\".request_size, \"datahistoryjob\".max_retries, \"datahistoryjob\".batch_count, \"datahistoryjob\".status, \"datahistoryjob\".created, \"datahistoryjob\".conversion_interval, \"datahistoryjob\".overwrite_data, \"datahistoryjob\".decimal_place_comparison, \"datahistoryjob\".secondary_exchange_id, \"datahistoryjob\".issue_tolerance_percentage, \"datahistoryjob\".replace_on_issue, \"a\".\"prerequisite_job_id\""),
		qm.From("\"datahistoryjob\""),
...
func (datahistoryjobL) LoadJobDatahistoryjobresults(ctx context.Context, e boil.ContextExecutor, singular bool, maybeDatahistoryjob interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`datahistoryjobresult`),
		qm.WhereIn(`datahistoryjobresult.job_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func FindDatahistoryjob(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*Datahistoryjob, error) {
	...
	if err = datahistoryjobObj.doAfterSelectHooks(ctx, exec); err != nil {
		return datahistoryjobObj, err
	}
