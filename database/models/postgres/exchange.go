...
type exchangeR struct {
	ExchangeNameCandles              CandleSlice            `boil:"ExchangeNameCandles" json:"ExchangeNameCandles" toml:"ExchangeNameCandles" yaml:"ExchangeNameCandles"`
	ExchangeNameDatahistoryjobs      DatahistoryjobSlice    `boil:"ExchangeNameDatahistoryjobs" json:"ExchangeNameDatahistoryjobs" toml:"ExchangeNameDatahistoryjobs" yaml:"ExchangeNameDatahistoryjobs"`
	SecondaryExchangeDatahistoryjobs DatahistoryjobSlice    `boil:"SecondaryExchangeDatahistoryjobs" json:"SecondaryExchangeDatahistoryjobs" toml:"SecondaryExchangeDatahistoryjobs" yaml:"SecondaryExchangeDatahistoryjobs"`
	ExchangeNameTrades               TradeSlice             `boil:"ExchangeNameTrades" json:"ExchangeNameTrades" toml:"ExchangeNameTrades" yaml:"ExchangeNameTrades"`
	ExchangeNameWithdrawalHistories  WithdrawalHistorySlice `boil:"ExchangeNameWithdrawalHistories" json:"ExchangeNameWithdrawalHistories" toml:"ExchangeNameWithdrawalHistories" yaml:"ExchangeNameWithdrawalHistories"`
}
...
type (
	...
	// This should almost always be used instead of []Exchange.
...
func (exchangeL) LoadExchangeNameCandles(ctx context.Context, e boil.ContextExecutor, singular bool, maybeExchange interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`candle`),
		qm.WhereIn(`candle.exchange_name_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (exchangeL) LoadExchangeNameDatahistoryjobs(ctx context.Context, e boil.ContextExecutor, singular bool, maybeExchange interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`datahistoryjob.exchange_name_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (exchangeL) LoadSecondaryExchangeDatahistoryjobs(ctx context.Context, e boil.ContextExecutor, singular bool, maybeExchange interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`datahistoryjob`),
		qm.WhereIn(`datahistoryjob.secondary_exchange_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (exchangeL) LoadExchangeNameTrades(ctx context.Context, e boil.ContextExecutor, singular bool, maybeExchange interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`trade`),
		qm.WhereIn(`trade.exchange_name_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (exchangeL) LoadExchangeNameWithdrawalHistories(ctx context.Context, e boil.ContextExecutor, singular bool, maybeExchange interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`withdrawal_history`),
		qm.WhereIn(`withdrawal_history.exchange_name_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func FindExchange(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*Exchange, error) {
	...
	if err = exchangeObj.doAfterSelectHooks(ctx, exec); err != nil {
		return exchangeObj, err
	}
