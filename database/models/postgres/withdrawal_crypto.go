...
var WithdrawalCryptoTableColumns = struct {
	ID                 string
	WithdrawalCryptoID string
	Address            string
	AddressTag         string
	...
	ID:                 "withdrawal_crypto.id",
	WithdrawalCryptoID: "withdrawal_crypto.withdrawal_crypto_id",
	Address:            "withdrawal_crypto.address",
	AddressTag:         "withdrawal_crypto.address_tag",
	Fee:                "withdrawal_crypto.fee",
}
...
type withdrawalCryptoR struct {
	WithdrawalCrypto *WithdrawalHistory `boil:"WithdrawalCrypto" json:"WithdrawalCrypto" toml:"WithdrawalCrypto" yaml:"WithdrawalCrypto"`
}
...
type (
	...
	// This should almost always be used instead of []WithdrawalCrypto.
...
func FindWithdrawalCrypto(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*WithdrawalCrypto, error) {
	...
	if err = withdrawalCryptoObj.doAfterSelectHooks(ctx, exec); err != nil {
		return withdrawalCryptoObj, err
	}
