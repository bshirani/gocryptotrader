...
var (
	liveTradeDBTypes = map[string]string{`ID`: `INTEGER`, `Side`: `TEXT`, `EntryOrderID`: `TEXT`, `EntryPrice`: `REAL`, `StopLossPrice`: `REAL`, `StrategyID`: `TEXT`, `Status`: `TEXT`, `Pair`: `TEXT`, `TakeProfitPrice`: `REAL`, `ProfitLossPoints`: `REAL`, `ExitPrice`: `REAL`}
	_                = bytes.MinRead
)
