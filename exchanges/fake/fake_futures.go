...
func (k *Fake) GetFuturesOrderbook(ctx context.Context, symbol currency.Pair) (FuturesOrderbookData, error) {
...
func (k *Fake) GetFuturesMarkets(ctx context.Context) (FuturesInstrumentData, error) {
...
func (k *Fake) GetFuturesTickers(ctx context.Context) (FuturesTickerData, error) {
...
func (k *Fake) GetFuturesTradeHistory(ctx context.Context, symbol currency.Pair, lastTime time.Time) (FuturesTradeHistoryData, error) {
...
func (k *Fake) FuturesBatchOrder(ctx context.Context, data []PlaceBatchOrderData) (FuturesAccountsData, error) {
...
func (k *Fake) FuturesEditOrder(ctx context.Context, orderID, clientOrderID string, size, limitPrice, stopPrice float64) (FuturesAccountsData, error) {
	var resp FuturesAccountsData
	params := url.Values{}
	if orderID != "" {
...
func (k *Fake) FuturesSendOrder(ctx context.Context, orderType order.Type, symbol currency.Pair, side, triggerSignal, clientOrderID, reduceOnly string,
...
func (k *Fake) FuturesCancelOrder(ctx context.Context, orderID, clientOrderID string) (FuturesCancelOrderData, error) {
...
func (k *Fake) FuturesGetFills(ctx context.Context, lastFillTime time.Time) (FuturesFillsData, error) {
...
func (k *Fake) FuturesTransfer(ctx context.Context, fromAccount, toAccount, unit string, amount float64) (FuturesTransferData, error) {
...
func (k *Fake) FuturesGetOpenPositions(ctx context.Context) (FuturesOpenPositions, error) {
...
func (k *Fake) FuturesNotifications(ctx context.Context) (FuturesNotificationData, error) {
...
func (k *Fake) FuturesCancelAllOrders(ctx context.Context, symbol currency.Pair) (CancelAllOrdersData, error) {
...
func (k *Fake) FuturesCancelAllOrdersAfter(ctx context.Context, timeout int64) (CancelOrdersAfterData, error) {
...
func (k *Fake) FuturesOpenOrders(ctx context.Context) (FuturesOpenOrdersData, error) {
...
func (k *Fake) FuturesRecentOrders(ctx context.Context, symbol currency.Pair) (FuturesRecentOrdersData, error) {
...
func (k *Fake) FuturesWithdrawToSpotWallet(ctx context.Context, currency string, amount float64) (GenericResponse, error) {
...
func (k *Fake) FuturesGetTransfers(ctx context.Context, lastTransferTime time.Time) (GenericResponse, error) {
	var resp GenericResponse
	params := url.Values{}
...
func (k *Fake) GetFuturesAccountData(ctx context.Context) (FuturesAccountsData, error) {
	var resp FuturesAccountsData
	return resp, k.SendFuturesAuthRequest(ctx, http.MethodGet, futuresAccountData, nil, nil, &resp)
}

func (k *Fake) signFuturesRequest(endpoint, nonce, data string) (string, error) {
...
func (k *Fake) SendFuturesAuthRequest(ctx context.Context, method, path string, postData url.Values, data map[string]interface{}, result interface{}) error {
