...
const (
	...
	kucoinTradeBalance     = "TradeBalance"
	kucoinOpenOrders       = "OpenOrders"
	kucoinClosedOrders     = "ClosedOrders"
	kucoinQueryOrders      = "QueryOrders"
	kucoinTradeHistory     = "TradesHistory"
	kucoinQueryTrades      = "QueryTrades"
	kucoinOpenPositions    = "OpenPositions"
	kucoinLedgers          = "Ledgers"
	kucoinQueryLedgers     = "QueryLedgers"
	kucoinTradeVolume      = "TradeVolume"
	kucoinOrderCancel      = "CancelOrder"
	kucoinOrderPlace       = "AddOrder"
	kucoinWithdrawInfo     = "WithdrawInfo"
	kucoinWithdraw         = "Withdraw"
	kucoinDepositMethods   = "DepositMethods"
	kucoinDepositAddresses = "DepositAddresses"
	kucoinWithdrawStatus   = "WithdrawStatus"
	kucoinWithdrawCancel   = "WithdrawCancel"
	kucoinWebsocketToken   = "GetWebSocketsToken"
	...
	// Rate limit consts
	kucoinRateInterval = time.Second
	kucoinRequestRate  = 1
...
// KucoinResponse wraps the Kucoin API JSON response
