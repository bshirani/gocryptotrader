...
func (k *Kucoin) GetFuturesOrderbook(ctx context.Context, symbol currency.Pair) (FuturesOrderbookData, error) {
...
func (k *Kucoin) GetFuturesMarkets(ctx context.Context) (FuturesInstrumentData, error) {
...
func (k *Kucoin) GetFuturesTickers(ctx context.Context) (FuturesTickerData, error) {
...
func (k *Kucoin) GetFuturesTradeHistory(ctx context.Context, symbol currency.Pair, lastTime time.Time) (FuturesTradeHistoryData, error) {
...
func (k *Kucoin) FuturesBatchOrder(ctx context.Context, data []PlaceBatchOrderData) (FuturesAccountsData, error) {
...
func (k *Kucoin) FuturesEditOrder(ctx context.Context, orderID, clientOrderID string, size, limitPrice, stopPrice float64) (FuturesAccountsData, error) {
	var resp FuturesAccountsData
	params := url.Values{}
	if orderID != "" {
...
func (k *Kucoin) FuturesSendOrder(ctx context.Context, orderType order.Type, symbol currency.Pair, side, triggerSignal, clientOrderID, reduceOnly string,
...
func (k *Kucoin) FuturesCancelOrder(ctx context.Context, orderID, clientOrderID string) (FuturesCancelOrderData, error) {
...
func (k *Kucoin) FuturesGetFills(ctx context.Context, lastFillTime time.Time) (FuturesFillsData, error) {
...
func (k *Kucoin) FuturesTransfer(ctx context.Context, fromAccount, toAccount, unit string, amount float64) (FuturesTransferData, error) {
...
func (k *Kucoin) FuturesGetOpenPositions(ctx context.Context) (FuturesOpenPositions, error) {
...
func (k *Kucoin) FuturesNotifications(ctx context.Context) (FuturesNotificationData, error) {
...
func (k *Kucoin) FuturesCancelAllOrders(ctx context.Context, symbol currency.Pair) (CancelAllOrdersData, error) {
...
func (k *Kucoin) FuturesCancelAllOrdersAfter(ctx context.Context, timeout int64) (CancelOrdersAfterData, error) {
...
func (k *Kucoin) FuturesOpenOrders(ctx context.Context) (FuturesOpenOrdersData, error) {
...
func (k *Kucoin) FuturesRecentOrders(ctx context.Context, symbol currency.Pair) (FuturesRecentOrdersData, error) {
...
func (k *Kucoin) FuturesWithdrawToSpotWallet(ctx context.Context, currency string, amount float64) (GenericResponse, error) {
...
func (k *Kucoin) FuturesGetTransfers(ctx context.Context, lastTransferTime time.Time) (GenericResponse, error) {
	var resp GenericResponse
	params := url.Values{}
...
func (k *Kucoin) GetFuturesAccountData(ctx context.Context) (FuturesAccountsData, error) {
	var resp FuturesAccountsData
	return resp, k.SendFuturesAuthRequest(ctx, http.MethodGet, futuresAccountData, nil, nil, &resp)
}

func (k *Kucoin) signFuturesRequest(endpoint, nonce, data string) (string, error) {
...
func (k *Kucoin) SendFuturesAuthRequest(ctx context.Context, method, path string, postData url.Values, data map[string]interface{}, result interface{}) error {
